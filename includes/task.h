...
extern void trm_task_free(struct task_struct *task);
extern void trm_cred_free(struct cred *cred);
// extern void trm_bprm_committed_creds(struct linux_binprm *bprm);
