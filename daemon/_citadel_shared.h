...
#define _CITADEL_XATTR_NAMESPACE "citadel"
...
#define _TRM_XATTR_ROOT _CITADEL_SECURITY_ROOT "." _CITADEL_XATTR_NAMESPACE
#define _TRM_XATTR_IN_REALM _TRM_XATTR_ROOT "." _CITADEL_XATTR_TAG_IN_REALM
#define _TRM_XATTR_IDENTIFIER _TRM_XATTR_ROOT "." _CITADEL_XATTR_TAG_IDENTIFIER
#define _TRM_XATTR_INSTALL_ID _TRM_XATTR_ROOT "." _CITADEL_XATTR_TAG_INSTALL
